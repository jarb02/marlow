...
TOOL_TRUST_LEVELS: dict[str, int] = {
    ...
    "cdp_discover": TRUST_OBSERVE,
    "cdp_list_connections": TRUST_OBSERVE,
    "cdp_screenshot": TRUST_OBSERVE,
    "cdp_get_dom": TRUST_OBSERVE,
    "cdp_get_knowledge_base": TRUST_OBSERVE,
    ...
    "cdp_connect": TRUST_LAUNCH,
    "cdp_disconnect": TRUST_LAUNCH,
    "cdp_ensure": TRUST_LAUNCH,
    ...
    "cdp_click": TRUST_INTERACT,
    "cdp_type_text": TRUST_INTERACT,
    "cdp_key_combo": TRUST_INTERACT,
    "cdp_click_selector": TRUST_INTERACT,
    "cdp_send": TRUST_INTERACT,
    ...
    "cdp_restart_confirmed": TRUST_COMMAND,
